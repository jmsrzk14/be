...
func NewClubHandler(db *gorm.DB, notificationService *services.NotificationService) *ClubHandler {
	return &ClubHandler{
...
func (h *ClubHandler) CreateClub(c *gin.Context) {
	...
	title := "UKM Baru: " + club.Name
	message := fmt.Sprintf("UKM baru telah dibuat. Cek sekarang!")
